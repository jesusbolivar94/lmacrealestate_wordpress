						...
						<?php if ( $main_fields_active ) : ?>
							<?php foreach ( $attributes['main_fields'] as $field ) :
								...
								if ( $field_config && ! empty( $field_config['search_support'] ) ) :
									...
									ob_start(); do_action( 'es_search_render_field_custom', $field, $attributes ); $content = ob_get_clean();
									if ( $content ) :
                                        if ($field == 'referencia') : ?>
                                            <li class="js-es-search-nav__single-item js-es-search-nav__item" data-placeholder="<?php echo $label; ?>"
                                                ...
                                                <input id="es-field-referencia" name="<?php echo $field; ?>"
                                                       class="es-field__input" data-single_unit="" data-plural_unit=""
                                                       type="text"
                                                       placeholder="<?php echo $label; ?>"
                                                       value="<?php echo sanitize_text_field(esc_attr($_GET['referencia'])); ?>">
                                            </li>
                                        <?php elseif ($field == 'es_type') : ?>
                                            <li class="js-es-search-nav__single-item js-es-search-nav__item es-type-li" data-placeholder="<?php echo $label; ?>"
                                                data-field="<?php echo $field; ?>"
                                                data-range-enabled="<?php echo $is_range_mode; ?>"
                                                data-formatter="<?php echo $field_config['formatter']; ?>">
                                                <?php echo $content; ?>
                                        ...
                                        <?php elseif ($field == 'price') : ?>
                                            <li class="js-es-search-nav__single-item js-es-search-nav__item price-li" data-placeholder="<?php echo $label; ?>"
                                                data-field="<?php echo $field; ?>"
                                                data-range-enabled="<?php echo $is_range_mode; ?>"
                                                data-formatter="<?php echo $field_config['formatter']; ?>">
                                                <?php echo $content; ?>
